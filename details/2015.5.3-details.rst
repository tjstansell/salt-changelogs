...
*Generated at: 2015-07-07T23:25:36Z*

Statistics:

- Total Merges: **178**
- Total Issue references: **81**
- Total PR references: **232**

Changes:


- **PR** `#25109`_: (*jfindlay*) add 2015.5.3 release notes
  @ *2015-07-01T19:45:56Z*

  * f0f512a Merge pull request `#25109`_ from jfindlay/2015.5
  * 3187d5d add 2015.5.3 release notes
...
- **PR** `#25065`_: (*lorengordon*) Add download links for 2015.5.1-3 and 2015.5.2 Windows installers
  ...
  - **ISSUE** `#25057`_: (*TheBigBear*) Windows minion downloads are not updated when new releases are made
